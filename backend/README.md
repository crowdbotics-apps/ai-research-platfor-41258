...
## Project Structure
    ...
    ├── ai_research_platfor_41258  # Django project configurations
...
1. Clone this repo and `cd ai_research_platfor_41258`
...
2. Clone this repo and `cd ai_research_platfor_41258`
